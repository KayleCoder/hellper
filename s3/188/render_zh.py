...
ERASE_OVERRIDE = {
    # 铭牌有四行，OCR 只框到前两行；框在红牌内侧，用牌色填充
    '135.0': [(330, 28, 562, 342)],
}
MASK_ERASE = set()
erase_log = {}
FONT_MAX = {
    '002.0': 68, '003.0': 60, '021.0': 92, '029.0': 78, '030.0': 78,
    '044.1': 96, '045.0':110, '046.1': 88, '049.0': 58, '052.2': 54,
    '067.0': 66, '073.1': 58, '096.1': 84, '096.2': 60, '099.0': 66,
    '100.0': 60, '111.0':130, '112.0': 76, '113.1': 72, '118.1': 90,
    '133.0': 72, '146.3': 62, '151.1': 58, '162.2': 74, '164.1': 56,
    '169.2': 84, '175.3': 66, '175.4': 80, '180.0': 66, '110.0': 56,
    '095.1': 64, '119.0': 64, '126.1': 64, '147.1': 64, '152.0': 62,
    '155.0': 62, '158.1': 62, '161.0': 60, '161.3': 60, '162.1': 60,
    '135.0': 64, '087.0': 52, '057.3': 56,
}
EXTRA = {
}
zh = {}
